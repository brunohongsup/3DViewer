...
IMPLEMENT_DYNAMIC(CDeviceMFB_T, CDeviceTrigger)

BEGIN_MESSAGE_MAP(CDeviceMFB_T, CDeviceTrigger)
...
static LPCTSTR g_lpszParamMFB_T[EDeviceParameterMFB_T_Count] =
{
	_T("DeviceID"),
	_T("Board type"),
...
static LPCTSTR g_lpszDeviceMFB_T_Switch[2] =
{
	_T("False"),
	_T("True"),
};

CDeviceMFB_T::CDeviceMFB_T()
{
...
ptrdiff_t CDeviceMFB_T::OnMessage(CMessageBase * pMessage)
{
	...
	do
	{
		...
		for(int i = 0; i < nEncoderCounts * nChannel; ++i)
		{
			...
			{
				CString strName;
				strName.Format(_T("%s %s :"), !i ? _T("[CH1]") : _T("[CH2]"), CMultiLanguageManager::GetString(ELanguageParameter_EncoderCount));
...
EDeviceInitializeResult CDeviceMFB_T::Initialize()
{
...
EDeviceTerminateResult CDeviceMFB_T::Terminate()
{
...
bool CDeviceMFB_T::LoadSettings()
{
	bool bReturn = false;
	...
	do
	{
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_DeviceID, g_lpszParamMFB_T[EDeviceParameterMFB_T_DeviceID], _T("0"));

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseClearInitialize, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseClearInitialize], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 0);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseClearTerminate, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseClearTerminate], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 0);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_BoardType, g_lpszParamMFB_T[EDeviceParameterMFB_T_BoardType], _T("0"), EParameterFieldType_Combo, ConvertStringArrayToComboElement(g_lpszDeviceMSPBoardType, EDeviceMSPBoardType_Count), nullptr, 0);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_UIInfo, g_lpszParamMFB_T[EDeviceParameterMFB_T_UIInfo], _T("0"), EParameterFieldType_None, nullptr, nullptr, 0);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_ShowDIO, g_lpszParamMFB_T[EDeviceParameterMFB_T_ShowDIO], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 1);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_ShowTrgEnc, g_lpszParamMFB_T[EDeviceParameterMFB_T_ShowTrgEnc], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 1);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_ShowQueueCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_ShowQueueCH1], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 1);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_ShowQueueCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_ShowQueueCH2], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 1);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_ShowID, g_lpszParamMFB_T[EDeviceParameterMFB_T_ShowID], _T("1"), EParameterFieldType_Check, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_TriggerInfo, g_lpszParamMFB_T[EDeviceParameterMFB_T_TriggerInfo], _T("0"), EParameterFieldType_None, nullptr, nullptr, 0);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_Channel1, g_lpszParamMFB_T[EDeviceParameterMFB_T_Channel1], _T("1"), EParameterFieldType_None, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_EncoderDirectionCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_EncoderDirectionCH1], _T("0"), EParameterFieldType_Combo, ConvertStringArrayToComboElement(g_lpszDeviceEncoderDirection, EDeviceEncoderDirection_Count), nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_StartPositionCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_StartPositionCH1], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_EndPositionCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_EndPositionCH1], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_TriggerOnTimeCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_TriggerOnTimeCH1], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_TriggerCycleCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_TriggerCycleCH1], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_StrobeTimeCH1, g_lpszParamMFB_T[EDeviceParameterMFB_T_StrobeTimeCH1], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_Channel2, g_lpszParamMFB_T[EDeviceParameterMFB_T_Channel2], _T("1"), EParameterFieldType_None, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_EncoderDirectionCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_EncoderDirectionCH2], _T("0"), EParameterFieldType_Combo, ConvertStringArrayToComboElement(g_lpszDeviceEncoderDirection, EDeviceEncoderDirection_Count), nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_StartPositionCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_StartPositionCH2], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_EndPositionCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_EndPositionCH2], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_TriggerOnTimeCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_TriggerOnTimeCH2], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_TriggerCycleCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_TriggerCycleCH2], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);
		AddParameterFieldConfigurations(EDeviceParameterMFB_T_StrobeTimeCH2, g_lpszParamMFB_T[EDeviceParameterMFB_T_StrobeTimeCH2], _T("1"), EParameterFieldType_Edit, nullptr, nullptr, 2);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseInput, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseInput], _T("1"), EParameterFieldType_None, nullptr, nullptr, 0);

		for(int i = 0; i < MAX_IN_PORT; ++i)
			AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseInputNo0 + i, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseInputNo0 + i], _T("0"), EParameterFieldType_Check, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseOutput, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseOutput], _T("1"), EParameterFieldType_None, nullptr, nullptr, 0);

		for(int i = 0; i < MAX_OUT_PORT; ++i)
			AddParameterFieldConfigurations(EDeviceParameterMFB_T_UseOutputNo0 + i, g_lpszParamMFB_T[EDeviceParameterMFB_T_UseOutputNo0 + i], _T("0"), EParameterFieldType_Check, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_InputName, g_lpszParamMFB_T[EDeviceParameterMFB_T_InputName], _T("1"), EParameterFieldType_None, nullptr, nullptr, 0);

		for(int i = 0; i < MAX_IN_PORT; ++i)
			AddParameterFieldConfigurations(EDeviceParameterMFB_T_InputNo0Name + i, g_lpszParamMFB_T[EDeviceParameterMFB_T_InputNo0Name + i], _T(""), EParameterFieldType_Edit, nullptr, nullptr, 1);

		AddParameterFieldConfigurations(EDeviceParameterMFB_T_OutputName, g_lpszParamMFB_T[EDeviceParameterMFB_T_OutputName], _T("1"), EParameterFieldType_None, nullptr, nullptr, 0);

		for(int i = 0; i < MAX_OUT_PORT; ++i)
			AddParameterFieldConfigurations(EDeviceParameterMFB_T_OutputNo0Name + i, g_lpszParamMFB_T[EDeviceParameterMFB_T_OutputNo0Name + i], _T(""), EParameterFieldType_Edit, nullptr, nullptr, 1);
		...
		EDeviceMSPBoardType eBoardType = (EDeviceMSPBoardType)_ttoi(m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_BoardType].strParameterValue);
...
bool CDeviceMFB_T::PCIWrite(DWORD dwAddr, DWORD dwData)
{
	bool bReturn = false;
...
DWORD CDeviceMFB_T::PCIRead(DWORD dwAddr)
{
	DWORD dwData = 0;
...
DWORD CDeviceMFB_T::PciReadReg(DWORD dwOffset)
{
	DWORD dwRegValue = 0;
...
bool CDeviceMFB_T::PciWriteReg(DWORD dwOffset, DWORD dwData)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::PCIWrite(DWORD dwCS, DWORD dwAddr, DWORD dwData)
{
	bool bReturn = false;
...
DWORD CDeviceMFB_T::PCIRead(DWORD dwCS, DWORD dwAddr)
{
	DWORD dwReturn = 0;
...
bool CDeviceMFB_T::EnableTrigger()
{
	return false;
}

bool CDeviceMFB_T::DisableTrigger()
{
	return false;
}

bool CDeviceMFB_T::IsTriggerEnabled()
{
	return false;
}

long CDeviceMFB_T::GetEncoderCount()
{
	return 0;
}

long CDeviceMFB_T::GetTriggerCount()
{
	return 0;
}

bool CDeviceMFB_T::ResetCounter()
{
	return false;
}

long CDeviceMFB_T::GetChannelNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetQueueNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetQueueStatusPortNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetOutputPortNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetInputPortNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetEncoderPortNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetTriggerPortNumber()
{
	long nCount = 0;
...
long CDeviceMFB_T::GetEncoderCount(int nChannel)
{
	DWORD dwReturn = 0;
...
long CDeviceMFB_T::GetTriggerCount(int nChannel, int nSelect)
{
	DWORD dwReturn = 0;
...
bool CDeviceMFB_T::ResetDevice(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::ExcuteGrab(int nChannel, DWORD dwBitMask)
{
	bool bReturn = false;
		...
		case EDeviceMSPBoardType_MSP_P16_E2T6_Q288:
			{
				...
				case 0:
					{
						bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T6_Q288::EGrabAddress_CH1, dwBitMask);
						Sleep(1);
				...
				case 1:
					{
						bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T6_Q288::EGrabAddress_CH2, dwBitMask);
						Sleep(1);
		...
		case EDeviceMSPBoardType_MSP_P16_E2T2_Q16_1:
			{
				...
				case 0:
					{
						bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T2_Q16_1::EGrabAddress_CH1, dwBitMask);
						Sleep(1);
				...
				case 1:
					{
						bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T2_Q16_1::EGrabAddress_CH2, dwBitMask);
						Sleep(1);
		...
		case EDeviceMSPBoardType_MSP_P16_E2T2_Q16_2:
			{
				...
				{
				case 0:
					bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T2_Q16_2::EGrabAddress_CH1, dwBitMask);
					break;
				case 1:
					bReturn = PCIWrite(m_pDwCS[PCI_BASE_CS0] + MSP_P16_E2T2_Q16_2::EGrabAddress_CH2, dwBitMask);
					break;
				default:
					break;
				}
...
bool CDeviceMFB_T::ReadInBit(int nBit)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::ReadOutBit(int nBit)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::WriteOutBit(int nBit, bool bOn)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::SetQueuePosition(long nChannel, long nIndex, DWORD dwPos)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::SetQueueOrderPosition(long nChannel, long nIndex, DWORD dwCh)
{
	bool bReturn = false;
...
DWORD CDeviceMFB_T::GetQueueStatus(long nChannel, long nIndex)
{
	DWORD dwReturn = 0;
...
bool CDeviceMFB_T::EnableTrigger(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::DisableTrigger(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::IsTriggerEnabled(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::EnableLive(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::DisableLive(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::EnableLive(int nChannel, int nSelect)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::DisableLive(int nChannel, int nSelect)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::EnableGrab(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::EnableGrab(int nChannel, int nSelect)
{
	bool bReturn = false;
...
DWORD CDeviceMFB_T::GetAreaCameraCount(int nChannel)
{
	DWORD dwReturn = 0;
...
bool CDeviceMFB_T::UsingTrigger(int nChannel, bool bUse)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::GetID(int nChannel, DWORD* pParam)
{
	bool bReturn = false;
...
EGetFunctionMFB_T CDeviceMFB_T::GetBoardType(EDeviceMSPBoardType * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;

	do
	{
		if(!pParam)
		{
			eReturn = EGetFunctionMFB_T_NullptrError;
			break;
		}

		int nData = _ttoi(GetParamValue(EDeviceParameterMFB_T_BoardType));

		if(nData < 0 || nData >= (int)EDeviceMSPBoardType_Count)
		{
			eReturn = EGetFunctionMFB_T_EnumTypeError;
			break;
		}

		*pParam = (EDeviceMSPBoardType)nData;

		eReturn = EGetFunctionMFB_T_OK;
	}
	while(false);
...
ESetFunctionMFB_T CDeviceMFB_T::SetBoardType(EDeviceMSPBoardType eParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_BoardType;
	...
	do
	{
		...
		{
			eReturn = ESetFunctionMFB_T_NotFindCommandError;
			break;
		}

		if(IsInitialized())
		{
			eReturn = ESetFunctionMFB_T_AlreadyInitializedError;
			break;
		}
		...
		{
			eReturn = ESetFunctionMFB_T_WriteToDatabaseError;
			break;
		}
...
EGetFunctionMFB_T CDeviceMFB_T::GetUIShowDio(bool* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_ShowDIO));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUIShowDio(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_ShowDIO;
	...
	strMessage.Format(CMultiLanguageManager::GetString(ELanguageParameter__s_tochangetheparameter_s_from_s_to_s), !eReturn ? CMultiLanguageManager::GetString(ELanguageParameter_succeed) : CMultiLanguageManager::GetString(ELanguageParameter_failed), g_lpszParamMFB_T[eSaveID], g_lpszDeviceMFB_T_Switch[nPreValue], g_lpszDeviceMFB_T_Switch[bParam]);
...
EGetFunctionMFB_T CDeviceMFB_T::GetUIShowTrgEnc(bool* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_ShowTrgEnc));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUIShowTrgEnc(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_ShowTrgEnc;
...
EGetFunctionMFB_T CDeviceMFB_T::GetUIShowQueue_CH1(bool* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_ShowQueueCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUIShowQueue_CH1(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_ShowQueueCH1;
...
EGetFunctionMFB_T CDeviceMFB_T::GetUIShowQueue_CH2(bool* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_ShowQueueCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUIShowQueue_CH2(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_ShowQueueCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetUIShowID(bool* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_NullptrError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_ShowID));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUIShowID(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_ShowID;
...
EGetFunctionMFB_T CDeviceMFB_T::GetEncoderDirection_CH1(EDeviceEncoderDirection * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		int nData = _ttoi(GetParamValue(EDeviceParameterMFB_T_EncoderDirectionCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetEncoderDirection_CH1(EDeviceEncoderDirection eParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_EncoderDirectionCH1;
	...
	do
	{
		...
		if(IsInitialized())
		{
			...
			if(GetBoardType(&eBoardType))
			{
				eReturn = ESetFunctionMFB_T_ReadOnDatabaseError;
				break;
			}
	...
	strMessage.Format(CMultiLanguageManager::GetString(ELanguageParameter__s_tochangetheparameter_s_from_s_to_s), !eReturn ? CMultiLanguageManager::GetString(ELanguageParameter_succeed) : CMultiLanguageManager::GetString(ELanguageParameter_failed), g_lpszParamMFB_T[eSaveID], g_lpszDeviceEncoderDirection[nPreValue], g_lpszDeviceEncoderDirection[eParam]);
...
EGetFunctionMFB_T CDeviceMFB_T::GetEncoderDirection_CH2(EDeviceEncoderDirection * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		int nData = _ttoi(GetParamValue(EDeviceParameterMFB_T_EncoderDirectionCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetEncoderDirection_CH2(EDeviceEncoderDirection eParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_EncoderDirectionCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetStartPosition_CH1(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_StartPositionCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetStartPosition_CH1(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_StartPositionCH1;
	...
	do
	{
		if(IsInitialized())
		{
			...
			if(!bSetDevice)
			{
				eReturn = ESetFunctionMFB_T_WriteToDeviceError;
				break;
			}
		}
	...
	strMessage.Format(CMultiLanguageManager::GetString(ELanguageParameter__s_tochangetheparameter_s_from_d_to_d), !eReturn ? CMultiLanguageManager::GetString(ELanguageParameter_succeed) : CMultiLanguageManager::GetString(ELanguageParameter_failed), g_lpszParamMFB_T[eSaveID], nPreValue, nParam);
...
EGetFunctionMFB_T CDeviceMFB_T::GetStartPosition_CH2(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_StartPositionCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetStartPosition_CH2(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_StartPositionCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetEndPosition_CH1(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_EndPositionCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetEndPosition_CH1(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_EndPositionCH1;
...
EGetFunctionMFB_T CDeviceMFB_T::GetEndPosition_CH2(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_EndPositionCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetEndPosition_CH2(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_EndPositionCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetTriggerOnTime_CH1(int* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_TriggerOnTimeCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetTriggerOnTime_CH1(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_TriggerOnTimeCH1;
...
EGetFunctionMFB_T CDeviceMFB_T::GetTriggerOnTime_CH2(int* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_TriggerOnTimeCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetTriggerOnTime_CH2(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_TriggerOnTimeCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetTriggerCycle_CH1(int* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_TriggerCycleCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetTriggerCycle_CH1(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_TriggerCycleCH1;
...
EGetFunctionMFB_T CDeviceMFB_T::GetTriggerCycle_CH2(int* pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_TriggerCycleCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetTriggerCycle_CH2(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_TriggerCycleCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetStrobeTime_CH1(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_StrobeTimeCH1));
...
ESetFunctionMFB_T CDeviceMFB_T::SetStrobeTime_CH1(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_StrobeTimeCH1;
...
EGetFunctionMFB_T CDeviceMFB_T::GetStrobeTime_CH2(int * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_StrobeTimeCH2));
...
ESetFunctionMFB_T CDeviceMFB_T::SetStrobeTime_CH2(int nParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveID = EDeviceParameterMFB_T_StrobeTimeCH2;
...
EGetFunctionMFB_T CDeviceMFB_T::GetUseClearInitalize(bool * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_UseClearInitialize));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUseClearInitalize(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveNum = EDeviceParameterMFB_T_UseClearInitialize;
	...
	strMessage.Format(CMultiLanguageManager::GetString(ELanguageParameter__s_tochangetheparameter_s_from_s_to_s), !eReturn ? CMultiLanguageManager::GetString(ELanguageParameter_succeed) : CMultiLanguageManager::GetString(ELanguageParameter_failed), g_lpszParamMFB_T[eSaveNum], g_lpszDeviceMFB_T_Switch[bPreValue], g_lpszDeviceMFB_T_Switch[bParam]);
...
EGetFunctionMFB_T CDeviceMFB_T::GetUseClearTerminate(bool * pParam)
{
	EGetFunctionMFB_T eReturn = EGetFunctionMFB_T_UnknownError;
	...
	do
	{
		...
		*pParam = _ttoi(GetParamValue(EDeviceParameterMFB_T_UseClearTerminate));
...
ESetFunctionMFB_T CDeviceMFB_T::SetUseClearTerminate(bool bParam)
{
	ESetFunctionMFB_T eReturn = ESetFunctionMFB_T_UnknownError;

	EDeviceParameterMFB_T eSaveNum = EDeviceParameterMFB_T_UseClearTerminate;
...
bool CDeviceMFB_T::OnParameterChanged(int nParam, CString strValue)
{
	bool bReturn = false;
	...
	do
	{
		switch(nParam)
		{
		case EDeviceParameterMFB_T_DeviceID:
			bReturn = !SetDeviceID(strValue);
			break;
		case EDeviceParameterMFB_T_BoardType:
			bReturn = !SetBoardType((EDeviceMSPBoardType)_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_ShowDIO:
			bReturn = !SetUIShowDio(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_ShowTrgEnc:
			bReturn = !SetUIShowTrgEnc(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_ShowQueueCH1:
			bReturn = !SetUIShowQueue_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_ShowQueueCH2:
			bReturn = !SetUIShowQueue_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_ShowID:
			bReturn = !SetUIShowID(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_EncoderDirectionCH1:
			bReturn = !SetEncoderDirection_CH1((EDeviceEncoderDirection)_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_EncoderDirectionCH2:
			bReturn = !SetEncoderDirection_CH2((EDeviceEncoderDirection)_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_TriggerOnTimeCH1:
			bReturn = !SetTriggerOnTime_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_TriggerOnTimeCH2:
			bReturn = !SetTriggerOnTime_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_TriggerCycleCH1:
			bReturn = !SetTriggerCycle_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_TriggerCycleCH2:
			bReturn = !SetTriggerCycle_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_StartPositionCH1:
			bReturn = !SetStartPosition_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_EndPositionCH1:
			bReturn = !SetEndPosition_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_StartPositionCH2:
			bReturn = !SetStartPosition_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_EndPositionCH2:
			bReturn = !SetEndPosition_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_StrobeTimeCH1:
			bReturn = !SetStrobeTime_CH1(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_StrobeTimeCH2:
			bReturn = !SetStrobeTime_CH2(_ttoi(strValue));
			break;
		case EDeviceParameterMFB_T_UseInputNo0:
		case EDeviceParameterMFB_T_UseInputNo1:
		case EDeviceParameterMFB_T_UseInputNo2:
		case EDeviceParameterMFB_T_UseInputNo3:
		case EDeviceParameterMFB_T_UseInputNo4:
		case EDeviceParameterMFB_T_UseInputNo5:
		case EDeviceParameterMFB_T_UseInputNo6:
		case EDeviceParameterMFB_T_UseInputNo7:
		case EDeviceParameterMFB_T_UseInputNo8:
		case EDeviceParameterMFB_T_UseInputNo9:
		case EDeviceParameterMFB_T_UseInputNo10:
		case EDeviceParameterMFB_T_UseInputNo11:
		case EDeviceParameterMFB_T_UseInputNo12:
		case EDeviceParameterMFB_T_UseInputNo13:
		case EDeviceParameterMFB_T_UseInputNo14:
		case EDeviceParameterMFB_T_UseInputNo15:
			{
			...
			break;
		case EDeviceParameterMFB_T_UseOutputNo0:
		case EDeviceParameterMFB_T_UseOutputNo1:
		case EDeviceParameterMFB_T_UseOutputNo2:
		case EDeviceParameterMFB_T_UseOutputNo3:
		case EDeviceParameterMFB_T_UseOutputNo4:
		case EDeviceParameterMFB_T_UseOutputNo5:
		case EDeviceParameterMFB_T_UseOutputNo6:
		case EDeviceParameterMFB_T_UseOutputNo7:
		case EDeviceParameterMFB_T_UseOutputNo8:
		case EDeviceParameterMFB_T_UseOutputNo9:
		case EDeviceParameterMFB_T_UseOutputNo10:
		case EDeviceParameterMFB_T_UseOutputNo11:
		case EDeviceParameterMFB_T_UseOutputNo12:
		case EDeviceParameterMFB_T_UseOutputNo13:
		case EDeviceParameterMFB_T_UseOutputNo14:
		case EDeviceParameterMFB_T_UseOutputNo15:
			{
				int nPreValue = _ttoi(GetParamValue(nParam));
				int nValue = _ttoi(strValue);
				...
				if(SetParamValue(nParam, strValue))
				{
					m_pUsedOutput[nParam - EDeviceParameterMFB_T_UseOutputNo0] = nValue;
			...
			break;
		case EDeviceParameterMFB_T_InputNo0Name:
		case EDeviceParameterMFB_T_InputNo1Name:
		case EDeviceParameterMFB_T_InputNo2Name:
		case EDeviceParameterMFB_T_InputNo3Name:
		case EDeviceParameterMFB_T_InputNo4Name:
		case EDeviceParameterMFB_T_InputNo5Name:
		case EDeviceParameterMFB_T_InputNo6Name:
		case EDeviceParameterMFB_T_InputNo7Name:
		case EDeviceParameterMFB_T_InputNo8Name:
		case EDeviceParameterMFB_T_InputNo9Name:
		case EDeviceParameterMFB_T_InputNo10Name:
		case EDeviceParameterMFB_T_InputNo11Name:
		case EDeviceParameterMFB_T_InputNo12Name:
		case EDeviceParameterMFB_T_InputNo13Name:
		case EDeviceParameterMFB_T_InputNo14Name:
		case EDeviceParameterMFB_T_InputNo15Name:
			{
				CString strPreValue = GetParamValue(nParam);

				if(SetParamValue(nParam, strValue))
				{
					int nIndex = nParam - EDeviceParameterMFB_T_InputNo0Name;
			...
			break;
		case EDeviceParameterMFB_T_OutputNo0Name:
		case EDeviceParameterMFB_T_OutputNo1Name:
		case EDeviceParameterMFB_T_OutputNo2Name:
		case EDeviceParameterMFB_T_OutputNo3Name:
		case EDeviceParameterMFB_T_OutputNo4Name:
		case EDeviceParameterMFB_T_OutputNo5Name:
		case EDeviceParameterMFB_T_OutputNo6Name:
		case EDeviceParameterMFB_T_OutputNo7Name:
		case EDeviceParameterMFB_T_OutputNo8Name:
		case EDeviceParameterMFB_T_OutputNo9Name:
		case EDeviceParameterMFB_T_OutputNo10Name:
		case EDeviceParameterMFB_T_OutputNo11Name:
		case EDeviceParameterMFB_T_OutputNo12Name:
		case EDeviceParameterMFB_T_OutputNo13Name:
		case EDeviceParameterMFB_T_OutputNo14Name:
		case EDeviceParameterMFB_T_OutputNo15Name:
			{
				CString strPreValue = GetParamValue(nParam);

				if(SetParamValue(nParam, strValue))
				{
					int nIndex = nParam - EDeviceParameterMFB_T_OutputNo0Name;
			...
			break;
		case EDeviceParameterMFB_T_UseClearInitialize:
			bReturn = !SetUseClearInitalize(_ttoi(strValue));
			bFoundID = true;
			break;
		case EDeviceParameterMFB_T_UseClearTerminate:
...
bool CDeviceMFB_T::Display_P16_E2T6_Q288()
{
	bool bReturn = false;
	...
	do
	{
		...
		long* pEncoderCounts = new long[nTotalEncoders];
		memset(pEncoderCounts, 0, sizeof(long) * nTotalEncoders);

		long* pTriggerCounts = new long[nTotalTriggers];
		...
		DWORD* pQueueStatus = new DWORD[nTotalQueueStatus];
...
bool CDeviceMFB_T::Display_P16_E2T2_Q16()
{
	bool bReturn = false;
	...
	do
	{
		...
		DWORD* pQueueStatus = new DWORD[nTotalQueue];
...
bool CDeviceMFB_T::Display_DelayedQueue()
{
	bool bReturn = false;
...
void CDeviceMFB_T::SetPCIVendorID(unsigned short vendorId)
{
	m_vendorId = vendorId;
}

void CDeviceMFB_T::SetPCIDeviceID(unsigned short deviceId)
{
	m_deviceId = deviceId;
}

void CDeviceMFB_T::OnTimer(UINT_PTR nIDEvent)
{
	if(IsWindowVisible())
	{
...
BOOL CDeviceMFB_T::OnCommand(WPARAM wParam, LPARAM lParam)
{
	// TODO: 여기에 특수화된 코드를 추가 및/또는 기본 클래스를 호출합니다.
	return __super::OnCommand(wParam, lParam);
}

bool CDeviceMFB_T::DoesModuleExist()
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddIOs(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddIOsNotOutput1(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddIOsNotOutput2(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddIOsNotOutput3(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddTriggers(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddQueues(double dblDPIScale, int nStartID, CFont* pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddQueuesNotOutput(double dblDPIScale, int nStartID, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddButton(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMFB_T::AddIDs(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
void CDeviceMFB_T::DisplayParameter(EDeviceMSPBoardType eType)
{
	switch(eType)
	{
	case EDeviceMSPBoardType_MSP_P16_E2T6_Q288:
		{
			...
			for(int i = 0; i < MAX_IN_PORT; ++i)
			{
				m_pStrInputName[i] = m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_InputNo0Name + i].strParameterValue;
				m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_UseInputNo0 + i].strParameterValue = _T("1");
				SaveSettings(EDeviceParameterMFB_T_UseInputNo0 + i);
			}

			for(int i = 0; i < MAX_OUT_PORT; ++i)
			{
				m_pStrOutputName[i] = m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_OutputNo0Name + i].strParameterValue;
				m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_UseOutputNo0 + i].strParameterValue = _T("1");
				SaveSettings(EDeviceParameterMFB_T_UseOutputNo0 + i);
			}

			for(int i = EDeviceParameterMFB_T_UIInfo; i < EDeviceParameterMFB_T_TriggerInfo; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			for(int i = EDeviceParameterMFB_T_Channel1; i < EDeviceParameterMFB_T_EndPositionCH1; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			for(int i = EDeviceParameterMFB_T_EndPositionCH1; i < EDeviceParameterMFB_T_Channel2; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;

			for(int i = EDeviceParameterMFB_T_Channel2; i < EDeviceParameterMFB_T_EndPositionCH2; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			for(int i = EDeviceParameterMFB_T_EndPositionCH2; i < EDeviceParameterMFB_T_UseInput; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;

			for(int i = EDeviceParameterMFB_T_UseInput; i < EDeviceParameterMFB_T_InputName; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;

			for(int i = EDeviceParameterMFB_T_InputName; i < EDeviceParameterMFB_T_Count; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_ShowID].bShow = false;
		}
		break;
	case EDeviceMSPBoardType_MSP_P16_E2T2_Q16_1:
		{
			...
			for(int i = EDeviceParameterMFB_T_Channel1; i < EDeviceParameterMFB_T_Count; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;
	...
	case EDeviceMSPBoardType_MSP_P16_E2T2_Q16_2:
		{
			...
			for(int i = EDeviceParameterMFB_T_Channel1; i < EDeviceParameterMFB_T_UseOutput; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			for(int i = EDeviceParameterMFB_T_UseOutput; i < EDeviceParameterMFB_T_InputName; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;

			for(int i = EDeviceParameterMFB_T_InputName; i < EDeviceParameterMFB_T_OutputName; ++i)
				m_vctParameterFieldConfigurations[i].bShow = true;

			for(int i = EDeviceParameterMFB_T_OutputName; i < EDeviceParameterMFB_T_Count; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;
	...
	case EDeviceMSPBoardType_DelayedQueue:
		{
			for(int i = EDeviceParameterMFB_T_UIInfo; i < EDeviceParameterMFB_T_Count; ++i)
				m_vctParameterFieldConfigurations[i].bShow = false;

			m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_UIInfo].bShow = true;
			m_vctParameterFieldConfigurations[EDeviceParameterMFB_T_ShowID].bShow = true;
		}
		break;
	default:
		break;
...
void CDeviceMFB_T::OnBnClickedOutLed(UINT nID)
{
	do
	{
		...
		{
			EDeviceMSPBoardType eType = EDeviceMSPBoardType_Count;

			if(!GetBoardType(&eType))
			{
				if(eType != EDeviceMSPBoardType_DelayedQueue)
...
void CDeviceMFB_T::OnBnClickedReset(UINT nID)
{
	do
	{
...
void CDeviceMFB_T::OnBnClickedEnableTrigger(UINT nID)
{
	do
	{
...
void CDeviceMFB_T::OnBnClickedDisableTrigger(UINT nID)
{
	do
	{
...
void CDeviceMFB_T::AllocateIO(long nInputSize, long nOutputSize)
{
	if(!m_pUsedInput)
...
void CDeviceMFB_T::AllocateQueue(long nQueueSizeX, long nQueueSizeY)
{
	if(!m_pQueueValueCh1)
	{
...
void CDeviceMFB_T::AllocateEncoder(long nEncoderSize)
{
...
void CDeviceMFB_T::AllocateTrigger(long nTriggerSize)
{
...
BOOL CDeviceMFB_T::OnInitDialog()
{
