...
namespace Ravid
{
	...
	namespace Device
	{
		class CDeviceDalsaGenieNanoGigE : public CDeviceCamera
		{
		public:
		...
		protected:
#ifndef _WIN64
			static void CallbackFunction(SapXferCallbackInfo *pInfo);
			static void CallbackProcessing(SapProCallbackInfo *pInfo);
#else
			static void WINAPI CallbackFunction(SapXferCallbackInfo* pInfo);
			static void WINAPI CallbackProcessing(SapProCallbackInfo* pInfo);
#endif
