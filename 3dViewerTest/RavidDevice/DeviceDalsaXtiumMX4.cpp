...
IMPLEMENT_DYNAMIC(CDeviceDalsaXtiumMX4, CDeviceFrameGrabber)

BEGIN_MESSAGE_MAP(CDeviceDalsaXtiumMX4, CDeviceFrameGrabber)
	ON_WM_TIMER()
	ON_WM_DESTROY()
END_MESSAGE_MAP()

static LPCTSTR g_lpszParamDalsaXtiumMX4[EDeviceParameterDalsaFrameGrabbers_Count] =
{
	_T("DeviceID"),
	_T("SubUnitID"),
	_T("CamFile Name"),
...
CDeviceDalsaXtiumMX4::CDeviceDalsaXtiumMX4()
{
}
...
EDeviceInitializeResult CDeviceDalsaXtiumMX4::Initialize()
{
	CString strMessage, strStatus(CMultiLanguageManager::GetString(ELanguageParameter_Terminated));

	if(!DoesModuleExist())
	{
		strMessage.Format(CMultiLanguageManager::GetString(ELanguageParameter_Couldntfind_s_APIdlls), _T("DalsaXtiumMX4"));
...
EDeviceTerminateResult CDeviceDalsaXtiumMX4::Terminate()
{
...
bool CDeviceDalsaXtiumMX4::LoadSettings()
{
	bool bReturn = false;
	...
	do
	{
		...
		AddParameterFieldConfigurations(nParam, g_lpszParamDalsaXtiumMX4[nParam], _T("Xtium2-CL_MX4_"), EParameterFieldType_Edit, nullptr, nullptr, 0);
		AddParameterFieldConfigurations(++nParam, g_lpszParamDalsaXtiumMX4[nParam], _T("0"), EParameterFieldType_Edit, nullptr, nullptr, 0);
		AddParameterFieldConfigurations(++nParam, g_lpszParamDalsaXtiumMX4[nParam], _T("DalsaXtiumMX4.ccf"), EParameterFieldType_Edit, nullptr, nullptr, 0);
...
EDeviceGrabResult CDeviceDalsaXtiumMX4::Grab()
{
...
EDeviceLiveResult CDeviceDalsaXtiumMX4::Live()
{
...
EDeviceStopResult CDeviceDalsaXtiumMX4::Stop()
{
...
EDeviceTriggerResult CDeviceDalsaXtiumMX4::Trigger()
{
...
BOOL CDeviceDalsaXtiumMX4::GetParameter(int param, void * pValue)
{
	bool bReturn = false;
...
BOOL CDeviceDalsaXtiumMX4::SetParameter(int param, int value, BOOL updateNow)
{
	bool bReturn = false;
...
BOOL CDeviceDalsaXtiumMX4::SetParameter(int param, void * pValue, BOOL updateNow)
{
	bool bReturn = false;
...
bool CDeviceDalsaXtiumMX4::OnParameterChanged(int nParam, CString strValue)
{
	bool bReturn = false;
...
void CDeviceDalsaXtiumMX4::CallbackFunction(SapXferCallbackInfo * pInfo)
{
	CDeviceDalsaXtiumMX4 *pInstance = (CDeviceDalsaXtiumMX4 *)pInfo->GetContext();
...
bool CDeviceDalsaXtiumMX4::DoesModuleExist()
{
	bool bReturn = false;
