...
#include "DeviceMVTechMSPTrigger.h"
...
IMPLEMENT_DYNAMIC(CDeviceMVTechMSPTrigger, CDeviceTrigger)

BEGIN_MESSAGE_MAP(CDeviceMVTechMSPTrigger, CDeviceTrigger)
...
CDeviceMVTechMSPTrigger::CDeviceMVTechMSPTrigger()
{
...
ptrdiff_t CDeviceMVTechMSPTrigger::OnMessage(CMessageBase * pMessage)
{
...
EDeviceInitializeResult CDeviceMVTechMSPTrigger::Initialize()
{
...
EDeviceTerminateResult CDeviceMVTechMSPTrigger::Terminate()
{
...
bool CDeviceMVTechMSPTrigger::LoadSettings()
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::PCIWrite(DWORD dwAddr, DWORD dwData)
{
	bool bReturn = false;
...
DWORD CDeviceMVTechMSPTrigger::PCIRead(DWORD dwAddr)
{
	DWORD dwData = 0;
...
DWORD CDeviceMVTechMSPTrigger::PciReadReg(DWORD dwOffset)
{
	DWORD dwRegValue = 0;
...
bool CDeviceMVTechMSPTrigger::PciWriteReg(DWORD dwOffset, DWORD dwData)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::PCIWrite(DWORD dwCS, DWORD dwAddr, DWORD dwData)
{
	bool bReturn = false;
...
DWORD CDeviceMVTechMSPTrigger::PCIRead(DWORD dwCS, DWORD dwAddr)
{
	DWORD dwReturn = 0;
...
bool CDeviceMVTechMSPTrigger::EnableTrigger()
{
	return false;
}

bool CDeviceMVTechMSPTrigger::DisableTrigger()
{
	return false;
}

bool CDeviceMVTechMSPTrigger::IsTriggerEnabled()
{
	return false;
}

long CDeviceMVTechMSPTrigger::GetEncoderCount()
{
	return 0;
}

long CDeviceMVTechMSPTrigger::GetTriggerCount()
{
	return 0;
}

bool CDeviceMVTechMSPTrigger::ResetCounter()
{
	return false;
}

long CDeviceMVTechMSPTrigger::GetChannelNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetQueueNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetQueueStatusPortNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetOutputPortNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetInputPortNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetEncoderPortNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetTriggerPortNumber()
{
	long nCount = 0;
...
long CDeviceMVTechMSPTrigger::GetEncoderCount(int nChannel)
{
	DWORD dwReturn = 0;
...
long CDeviceMVTechMSPTrigger::GetTriggerCount(int nChannel, int nSelect)
{
	DWORD dwReturn = 0;
...
bool CDeviceMVTechMSPTrigger::ResetDevice(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::ExcuteGrab(int nChannel, DWORD dwBitMask)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::ReadInBit(int nBit)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::ReadOutBit(int nBit)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::WriteOutBit(int nBit, bool bOn)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::SetQueuePosition(long nChannel, long nIndex, DWORD dwPos)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::SetQueueOrderPosition(long nChannel, long nIndex, DWORD dwCh)
{
	bool bReturn = false;
...
DWORD CDeviceMVTechMSPTrigger::GetQueueStatus(long nChannel, long nIndex)
{
	DWORD dwReturn = 0;
...
bool CDeviceMVTechMSPTrigger::EnableTrigger(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::DisableTrigger(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::IsTriggerEnabled(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::EnableLive(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::DisableLive(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::EnableLive(int nChannel, int nSelect)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::DisableLive(int nChannel, int nSelect)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::EnableGrab(int nChannel)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::EnableGrab(int nChannel, int nSelect)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::ResetDevice()
{
	bool bReturn = false;
...
DWORD CDeviceMVTechMSPTrigger::GetAreaCameraCount(int nChannel)
{
	DWORD dwReturn = 0;
...
bool CDeviceMVTechMSPTrigger::UsingTrigger(int nChannel, bool bUse)
{
	bool bReturn = false;
...
long CDeviceMVTechMSPTrigger::GetIDCount()
{
	long nCount = 0;
...
bool CDeviceMVTechMSPTrigger::GetID(int nChannel, DWORD* pParam)
{
	bool bReturn = false;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetBoardType(EDeviceMSPBoardType * pParam)
{
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetBoardType(EDeviceMSPBoardType eParam)
{
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetUIShowDio(bool* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_NullptrError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetUIShowDio(bool bParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetUIShowTrgEnc(bool* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_NullptrError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetUIShowTrgEnc(bool bParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetUIShowQueue_CH1(bool* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_NullptrError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetUIShowQueue_CH1(bool bParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetUIShowQueue_CH2(bool* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_NullptrError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetUIShowQueue_CH2(bool bParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetUIShowID(bool* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_NullptrError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetUIShowID(bool bParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetEncoderDirection_CH1(EDeviceEncoderDirection * pParam)
{
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetEncoderDirection_CH1(EDeviceEncoderDirection eParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetEncoderDirection_CH2(EDeviceEncoderDirection * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetEncoderDirection_CH2(EDeviceEncoderDirection eParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetStartPosition_CH1(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetStartPosition_CH1(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetStartPosition_CH2(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetStartPosition_CH2(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetEndPosition_CH1(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetEndPosition_CH1(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetEndPosition_CH2(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetEndPosition_CH2(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetTriggerOnTime_CH1(int* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetTriggerOnTime_CH1(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetTriggerOnTime_CH2(int* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetTriggerOnTime_CH2(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetTriggerCycle_CH1(int* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetTriggerCycle_CH1(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetTriggerCycle_CH2(int* pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetTriggerCycle_CH2(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetStrobeTime_CH1(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetStrobeTime_CH1(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
EMSPGetFunction CDeviceMVTechMSPTrigger::GetStrobeTime_CH2(int * pParam)
{
	EMSPGetFunction eReturn = EMSPGetFunction_UnknownError;
...
EMSPSetFunction CDeviceMVTechMSPTrigger::SetStrobeTime_CH2(int nParam)
{
	EMSPSetFunction eReturn = EMSPSetFunction_UnknownError;
...
bool CDeviceMVTechMSPTrigger::OnParameterChanged(int nParam, CString strValue)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::Display_P16_E2T6_Q288()
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::Display_P16_E2T2_Q16()
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::Display_DelayedQueue()
{
	bool bReturn = false;
...
void CDeviceMVTechMSPTrigger::OnTimer(UINT_PTR nIDEvent)
{
	if(IsWindowVisible())
	{
...
bool CDeviceMVTechMSPTrigger::DoesModuleExist()
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddControls()
{
	bool bReturn = false;
	CDC* pDC = nullptr;
...
bool CDeviceMVTechMSPTrigger::AddIOs(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddIOsNotOutput1(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddIOsNotOutput2(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddIOsNotOutput3(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddTriggers(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddQueues(double dblDPIScale, int nStartID, CFont* pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddQueuesNotOutput(double dblDPIScale, int nStartID, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddButton(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
bool CDeviceMVTechMSPTrigger::AddIDs(double dblDPIScale, CFont * pBaseFont, CRavidPoint<int> cpLeftTopPt, CRavidPoint<int> cpRightBottomPt, CRavidRect<int>* pResultGroupBox)
{
	bool bReturn = false;
...
void CDeviceMVTechMSPTrigger::DisplayParameter(EDeviceMSPBoardType eType)
{
	switch(eType)
	{
	case EDeviceMSPBoardType_MSP_P16_E2T6_Q288:
...
void CDeviceMVTechMSPTrigger::OnBnClickedOutLed(UINT nID)
{
	do
	{
...
void CDeviceMVTechMSPTrigger::OnBnClickedReset(UINT nID)
{
	do
	{
...
void CDeviceMVTechMSPTrigger::OnBnClickedEnableTrigger(UINT nID)
{
	do
	{
...
void CDeviceMVTechMSPTrigger::OnBnClickedDisableTrigger(UINT nID)
{
	do
	{
...
void CDeviceMVTechMSPTrigger::AllocateIO(long nInputSize, long nOutputSize)
{
	if(!m_pUsedInput)
...
void CDeviceMVTechMSPTrigger::FreeIO()
{
	if(m_pUsedInput)
	{
		delete[] m_pUsedInput;
...
void CDeviceMVTechMSPTrigger::AllocateQueue(long nQueueSizeX, long nQueueSizeY)
{
	if(!m_pQueueValueCh1)
	{
...
void CDeviceMVTechMSPTrigger::FreeQueue()
{
	if(m_pQueueValueCh1)
	{
...
void CDeviceMVTechMSPTrigger::AllocateEncoder(long nEncoderSize)
{
...
void CDeviceMVTechMSPTrigger::FreeEncoder()
{
	if(m_arrEncoderValue)
	{
...
void CDeviceMVTechMSPTrigger::AllocateTrigger(long nTriggerSize)
{
...
void CDeviceMVTechMSPTrigger::FreeTrigger()
{
	if(m_arrTriggerValue)
	{
...
BOOL CDeviceMVTechMSPTrigger::OnInitDialog()
{
	CDeviceTrigger::OnInitDialog();

	// TODO:  여기에 추가 초기화 작업을 추가합니다.

	SetTimer(RAVID_TIMER_TRIGGER, 100, nullptr);
...
void CDeviceMVTechMSPTrigger::OnDestroy()
{
	CDeviceTrigger::OnDestroy();

	// TODO: 여기에 메시지 처리기 코드를 추가합니다.
	KillTimer(RAVID_TIMER_TRIGGER);
}
